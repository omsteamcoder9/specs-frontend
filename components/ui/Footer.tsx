export default function Footer() {
  return (
    <footer className="bg-gradient-to-r from-amber-900 to-amber-700 text-white border-t border-amber-800 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-white/80">
              Your one-stop destination for books, stationery, and educational resources.
            </p>
          </div>
